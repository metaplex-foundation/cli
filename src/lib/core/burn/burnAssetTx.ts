...
const burnAssetTx = async (umi: Umi, assetId: string, collectionId?: string): Promise<TransactionBuilder> => {
  // Reason to use burnV1 is to save 9on RPC calls on fetching both the Asset and the collection if collection is known.
